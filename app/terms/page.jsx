...
export default function TermsPage() {
  const terms = [
    ["Service", "Credit Vivo provides a portal for credit report upload, customer-friendly findings, document organization, dispute workflow tracking, and educational guidance. Backend scanner rules are internal and are not shown as legal conclusions to customers."],
    ...
    ["Payments and third-party costs", "Monthly fees do not automatically include certified mail, postage, credit monitoring, identity verification, attorney review, third-party report access, or court/legal costs unless a written plan says they are included."],
    ...
    ["Cancellation", "Paid service agreements should include the cancellation rights required by federal and state law. Credit Vivo should not charge for credit repair services before legally permitted under the applicable agreement."],
  ];
